...
<div style="margin:50px;">
	...
	<table>
		...
		<tr>
			<td>收款方行名：</td>
			<td><input type="text" name="rcv_bank_name"></td>
		</tr>
		<tr>
			<td>收款人账号：</td>
			<td><input type="text" name="rcv_acno"></td>
		</tr>
		<tr>
			<td>收款人户名：</td>
			<td><input type="text" name="rcv_acname"></td>
		</tr>
		<tr>
			<td>金额：</td>
...
<script type="text/javascript">
	...
	var doSend = function() {
		...
		$.ajax({
			type : 'post',
			url : 'BOCOM2TransferAccounts.jsp',
			data : formData,
